...
public class RebuildNotableResponder implements Responder {
  ...
  public Response getResponse(Request r) {
    ...
    if (!body.matches("(?i)^(rebuildnotableusers)\\s*$")) { return null; } 
  ...
  public void addService(String name, Service service) {
    ...
    SingleFile notable = new SingleFile("notable.txt"); // Create the notable list if it doesn't exist at startup.
