...
public class ShadowrunDiceResponder implements Responder {
  ...
  public Documentation getDocumentation() {    
    ...
    return new Documentation(
        "Syntax: sr m or srx m, where m is a whole number.\n"+
  ...
  public Response getResponse(Request r) {
    ...
    if (!body.matches("srx?\\s+\\d+")) { return null; }
    ...
    return new Response(r.getChannel(),r.getSender() + ": " + shadowRunString + ", rolls: " + diceRollString + explodeResponse, Type.MESSAGE);
  }
