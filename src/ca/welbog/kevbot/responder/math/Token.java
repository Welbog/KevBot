...
public class Token {
  public static enum Types {
    CONST, MULT, DIV, MOD, PLUS, NEG, EXP, FACT, OPEN, CLOSE, FUNCT, SUB, TREE, COMMA, DICE, EXPLODING_DICE, VAR, GT, EQ, LT, LE, GE, NE, ASSIGN, STRING, PARAM
  };
  ...
  public static class TokenValue {
    ...
    public boolean isTokenCollection() {
      return tokenCollectionValue != null;
    }

    @JsonIgnore
    public boolean isEmpty() {
      return !(isString() || isDouble() || isInteger() || isTokenCollection());
    }
    ...
    public void setTokenCollection(TokenCollection collection) {
      tokenCollectionValue = collection;
    }
    ...
    public String toString() {
      ...
      if (isTokenCollection()) {
        return tokenCollectionValue.toString();
      }
      return "_";
    }
  }
