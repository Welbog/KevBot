...
public class TextInput {
     ...
     * @param file The name of the file from which to read.
     */
    public TextInput(String file) throws IOException { 
            in = new BufferedReader(new FileReader(file));
            currLine = in.readLine();
            if (currLine.equals("")) { throw new IOException(); }
    ...
    /**
     * Get the next word from this object.
     * A word is a String surrounded by whitespace.
    ...
    /**
     * Read the next word from this object.
     * This method is the same as getWord().
     */
   ...
   /**
     * Get the next line from this object.
     * A line is a String starting from the last word or line read, until the next newline character.
    ...
    /**
     * Get the next line from this object.
     * This method is the same as getLine().
     */
