 ...
 * <p>
 * Its special methods allow it to store and retrieve ints based on searchable Strings.
 * @version 1.0.0
 * @see Kevbot
 * @see DoubleFile
 */
public class KarmaFile extends DoubleFile {
     ...
     * @param m The file to store the karma words.
     * @param r The file to store the karma.
     */
     ...
     * @param s The String whose karma is to be changed.
     * @param x The amount the karma is to be changed.
     */
    public synchronized void changeKarma(String s, int x) {
        if (s.equals("")) { return; } // If we're given nothing, who cares?
