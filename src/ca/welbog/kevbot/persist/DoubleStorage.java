...
public interface DoubleStorage {
   ...
   * 
   * @param m
   *          The searchable String (message) to add.
   * @param r
   *          The indexed String (reply) to add.
   */
   ...
   *          The searchable String (message) to add.
   * @param r
   *          The indexed String (reply) to append.
   */
   ...
   * 
   * @param s
   *          The searchable String (message) to delete.
   */
   ...
   * 
   * @param m
   *          The searchable String (message) to change.
   * @param r
   *          The indexed String (reply) to add.
   ...
   * @return The indexed String (reply) corresponding to the given message, or
   ...
   * 
   * @param i
   *          The index of the string to look for.
   * @return The message/reply pair at the given index, or "" if the index is
   *         invalid.
   */
