 ...
 * <p>
 * SingleFile stores an alphabetically case-insensitive list of Strings
 * and can read/write this list to file. It also acts as the interface
 * between RAHL and KevBot, for queries/adds/deletes.
 *
 * @version 1.0.0
 * @see Kevbot
 * @see RAHL
...
public class SingleFile {
   ...
   * @param f The filename to be edited.
   */
  ...
  private void fillLines() {
    try { // The file exists.
      ...
      in.close(); // Close the IO steam.
        ...
        try {
      TextOutput out = new TextOutput(filename); // Open the IO stream, creating the file.
